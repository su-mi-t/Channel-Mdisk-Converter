...
SOURCE_CODE = os.environ.get("SOURCE_CODE", "https://github.com/su_mi_t/Channel-Mdisk-Converter")
USERNAME = os.environ.get("USERNAME", "Moviesforyours0")
HEADER_TEXT = os.environ.get("HEADER_TEXT", 'Join This Channel for More movies   ')
FOOTER_TEXT = os.environ.get("FOOTER_TEXT", 'join also our backup and main channel in case channel got terminate @Moviesforyours0')
